...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Start sampling from input image latent (img2img). Use --no_start_from_image to disable.",
    )
    parser.add_argument("--no_start_from_image", dest="start_from_image", action="store_false")
    parser.add_argument("--strength", type=float, default=0.0, help="Noise strength when starting from image")
