...
if is_torch2_available():
    from ip_adapter.attention_processor import IPAttnProcessor_mask2_0 as IPAttnProcessor, AttnProcessor2_0 as AttnProcessor
else:
...
def main():
    ...
    image_proj_model = ImageProjModel(
        ...
        clip_extra_context_tokens=args.num_tokens,
    )
    ...
    for name in unet.attn_processors.keys():
        ...
        if cross_attention_dim is None:
            ...
            # merge default init with unet text weights; tolerate extra mask params
